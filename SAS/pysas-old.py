...
def msg(name, message):
    return Label(name, text=message, fg="black", bg="white", bd=0, font=('ABeeZee-Regular', 8))
        ...
        if type == "user":
            ...
            for d in df.index:
                ...
                if code == x[7]:
                    ...
                    email = x[3]
                    send_mail("Thank you for making SAS account", email,
                              "Dear {name}, your SAS account has been created successfully.Now you can add cash in "
                              "your SAS wallet.\n\nUser Id : {i}\nContact : +91 {contact}\nEmail ID : {email}\nAddress"
                              " : {address}\nPincode : {pincode}\nDate and time of making account : {date} {time}"
                              "\n\nThank you for choosing us.".format(
                                  name=str(x[0]), contact=str(x[2]), email=str(x[3]), address=str(x[4]),
                                  pincode=str(x[5]), date=str(x[10]), time=str(x[11]), i=str(d)))
                    tmsg.showinfo("Verified Successfully",
                                  f"You have been verified successfully. Your User ID is {d}. For more details see your Email Inbox. ")
                    home_function()
...
home_button = Button(frame1, text='Home', bg="white", fg="black", font=("Blogger_Sans-Bold", 10, 'bold'),
                     activebackground="black", activeforeground="white", bd=0, cursor='hand2',
                     command=home_function)
...
products_button = Button(frame1, text='Products', bg="white", fg="grey", font=("Blogger_Sans-Bold", 10),
                         activebackground="black", activeforeground="white", bd=0, cursor='hand2',
...
account_button = Button(frame1, text='Account', bg="white", fg="grey", font=("Blogger_Sans-Bold", 10),
                        activebackground="black", activeforeground="white", bd=0, cursor='hand2',
                        command=account_function)
...
feedback_button = Button(frame1, text='Feedback', bg="white", fg="grey", font=("Blogger_Sans-Bold", 10),
                         activebackground="black", activeforeground="white", bd=0, cursor='hand2',
...
about_button = Button(frame1, text='About', bg="white", fg="grey", font=("Blogger_Sans-Bold", 10),
                      activebackground="black", activeforeground="white", bd=0, cursor='hand2',
...
Button(frame1, text='S  A  S', bg="white", fg="black", font=("Amaranth-Bold", 15, 'bold'), bd=0, command=home_function,
       cursor='hand2', activebackground='white', activeforeground='black').pack(side=LEFT, padx=25)
...
def user():
    ...
    cart_icon = Button(frame1, image=img3, bd=0, cursor="hand2",
                       command=lambda: [cart(frame2), frame1.forget(), frame2.forget(), products_frame.forget(),
                                        frame3.forget(), frame4.forget(), frame5.forget(), frame6.forget(),
                                        frame7.forget(), frame8.forget(), frame2.forget(), cart_frame.pack(side='left',
                                                                                                           anchor='nw',
                                                                                                           fill=BOTH,
                                                                                                           expand=True)]
                       )
    ...
    search_btn = Button(frame2, image=search_img, bd=0, cursor="hand2",
                        command=lambda: [search(search_user.get()), frame1.forget(), frame2.forget(),
                                         frame3.pack(side='left', anchor='nw', fill=BOTH, expand=True)])
...
def show_products():
    ...
    return_icon = Button(user_scrollabel_frame, image=img, bd=0, cursor="hand2",
                         command=return_back)
    return_icon.place(x=15, y=10)
    return_icon.image = img

    discover_label = Label(user_scrollabel_frame, text="Discover Products", bd=0, bg='white', fg='black',
                           font=('Helvetica bold',
                                 20))
    ...
    for i in df.index:
        ...
        Label(product_frame, textvariable=product_cost, bg='white', font=('Amaranth-Bold', 15, 'bold')).place(anchor=W,
                                                                                                              x=127,
                                                                                                              y=157)
        Label(product_frame, textvariable=product_name, bg='white', fg='black',
              font=('ABeeZee-Regular', 10, 'bold')).place(
            anchor=W,
            x=42,
            y=180)
        Label(product_frame, textvariable=product_details, bg='white', fg='#777777',
              font=('Amaranth-Regular', 8)).place(
            anchor=W,
            x=42,
            y=205)
        ...
        if int(x[3]) > 0:
            ...
            buy_button[i] = Button(product_frame, image=img3,
                                   cursor="hand2", bd=0, command=buy_action)
            ...
            for item in cart_df.index:
                ...
                if int(product_id.get()) == int(cart_list[0]):
                    ...
                    pass
                Label(product_frame, text="Product \nUnavailable", width=10, bg='#D8D8D8', fg='grey').place(anchor=NW,
                                                                                                            x=166,
                                                                                                            y=230)
...
def feedback():
    ...
    img = image(r"images/return_icon.png", 40, 40)
    return_icon = Button(frame9, image=img, bd=0, cursor="hand2",
                         command=return_back)
    return_icon.place(x=10, y=10)
    return_icon.image = img

    feedback_label = Label(feedback_frame, text="FEEDBACK", bd=0, bg='white', fg='black',
    ...
    # ISSUES / SUGGESTIONS RADIO BUTTON

    feedback_type = StringVar()
    feedback_type.set(value="Issue")

    Radiobutton(feedback_frame, variable=feedback_type, value='Issue', text='Issue', bd=0, bg='white', fg='black',
                cursor='hand2').place(x=90, y=247)
    Radiobutton(feedback_frame, variable=feedback_type, value='Suggestion', text='Suggestion', bd=0, bg='white',
                fg='black', cursor='hand2').place(x=180, y=247)

    # DESCRIPTION

    def on_enter_d1(e):
        if d1.get(1.0,
                  'end-1c') == "Describe your issue you've encountered here \nTell us how you'd like to improve SAS":
            d1.delete(1.0, END)
    ...
    d1.bind('<Return>', lambda e: [feedback_submit(str(e1.get()), str(e2.get()), str(feedback_type.get()),
                                                   str(d1.get(1.0, 'end-1c')))])
    ...
    b1 = Button(feedback_submit_frame, text='        S U B M I T        ', bg='black', fg='white',
                font=('Blogger_Sans-Bold', 10, 'bold'),
                activebackground='white', activeforeground='black', bd=0, cursor='hand2',
                command=lambda: [feedback_submit(str(e1.get()), str(e2.get()), str(feedback_type.get()),
                                                 str(d1.get(1.0, 'end-1c')))])
    b1.pack()
...
def about():
    ...
    img = image(r"images/return_icon.png", 40, 40)
    return_icon = Button(about_frame, image=img, bd=0, cursor="hand2",
                         command=return_back)
    return_icon.place(x=10, y=10)
    return_icon.image = img

    about_label = Label(admin_temp_login_frame, text="A B O U T", bd=0, bg='white', fg='black',
                        font=('Helvetica bold', 20))
    about_label.pack(padx=165, pady=50, side=TOP)

    Label(admin_temp_login_frame).pack(padx=600, pady=400)

    about_text = "SAS Stores is a general purpose stationary shop locate in Kolkata, \nWest Bengal. We provide a widerange of stationary items through our \nvast array of stationary supplies. We've partnered with major and \nreputable suppliers and manufacturersto ensure that only the best \nsupplies are sold. This has improved our brand and made \nus a trusted name in the Kolkata area.\n"

    Label(admin_temp_login_frame, bg='white', fg='black', bd=0, font=('Blogger_Sans', 10, 'italic'),
          text=about_text).place(x=28, y=140)
    Label(admin_temp_login_frame, bg='white', fg='black', bd=0, font=('Blogger_Sans', 10, 'bold'),
          text="Founder : Adarsh").place(x=28, y=260)
    Label(admin_temp_login_frame, bg='white', fg='black', bd=0, font=('Blogger_Sans', 10, 'bold'),
          text="Co - Founders: Saptarshi & Soumyadeep").place(x=28, y=300)
...
def cart(previous_frame):
    ...
    return_icon.image = img
    my_cart_label = Label(user_scrollabel_frame, text="My Cart", bd=0, bg='white', fg='black',
                          font=('Helvetica bold', 20))
    ...
    for i in product_df.index:
        for j in cart_df.index:
            ...
            if int(cart_list[0]) == i:
                ...
                Label(product_frame, textvariable=product_cost, bg='white', font=('Amaranth-Bold', 15, 'bold')).place(
                    anchor=W,
                    x=127,
                    y=157)
                Label(product_frame, textvariable=product_name, bg='white', fg='black',
                ...
                if int(product_list[3]) > 0:
                    ...
                    buy_button[i] = Button(product_frame, image=img2,
                                           cursor="hand2", bd=0, command=buy_action)
                    buy_button[i].place(anchor=NW, x=156, y=230)
                    buy_button[i].image = img2
                else:
                    Label(product_frame, text="Product \nUnavailable", width=10, bg='#D8D8D8', fg='grey').place(
                        anchor=NW,
                        x=166, y=230)
...
def search(name):
    ...
    img = image(r"images/return_icon.png", 40, 40)
    return_button = Button(user_scrollabel_frame, image=img, bd=0, cursor="hand2",
                           command=lambda: [frame3.forget(), frame1.pack(anchor=N, fill=X), frame2.pack(side='left',
                                                                                                        anchor='nw',
                                                                                                        fill=BOTH,
                                                                                                        expand=True),
                                            return_button.destroy(), search_label.destroy(), temp_frame.destroy()])
    ...
    for temp_row in range(15):
        Label(user_scrollabel_frame, bg='black', bd=0).grid(row=temp_row, column=0)

    search_label = Label(user_scrollabel_frame, text=f"Search Result(s) for {name}", bd=0, bg='white', fg='black',
                         font=('Helvetica bold', 20))
    search_label.place(x=592, y=114)
...
def register():
    ...
    img = image(r"images/return_icon.png", 40, 40)
    return_icon = Button(frame4, image=img, bd=0, cursor="hand2",
                         command=return_back)
    return_icon.place(x=10, y=10)
    return_icon.image = img
    ...
    register_label = Label(register_frame, text="REGISTER", bd=0, bg='white', fg='black',
                           font=('Helvetica bold', 20))
    ...
    user_wallet_balance = 0  # INITIAL SAS WALLET BALANCE
    ...
    user_password.bind('<Return>', lambda e: [otp_function(str(user_name.get()), str(user_age.get()),
                                                           str(user_contact.get()), str(user_email.get()),
                                                           str(user_address.get()), str(user_pincode.get()),
                                                           str(user_identity.get()), str(user_password.get()),
                                                           str(user_otp.get()), 'get_otp')])

    now = datetime.datetime.now()
    current_date = now.strftime("%d-%m-%y")  # CURRENT DATE WHEN USER WAS REGISTERING
    current_time = now.strftime("%H:%M:%S")  # CURRENT TIME WHEN USER WAS REGISTERING
    ...
    user_otp.bind('<Return>', lambda e: [otp_function(str(user_name.get()), str(user_age.get()),
                                                      str(user_contact.get()), str(user_email.get()),
                                                      str(user_address.get()), str(user_pincode.get()),
                                                      str(user_identity.get()), str(user_password.get()),
                                                      str(user_otp.get()), 'confirm')])
                ...
                if int(user_age.get()) > 17:
                    if user_contact.get().isdigit():
                        if len(user_contact.get()) == 10:
                                    ...
                                    if user_identity.get().isdigit():
                                        if len(user_identity.get()) == 12:
                                            if str(got_for) == 'get_otp':
                                                send_mail("OTP to register for SAS account", str(user_email.get()),
                                                          f"Your 6-digit otp numer is {otp}. Don't share this otp with anyone.")
                                                tmsg.showinfo(
                                                    'O T P Send Successfully',
                                                    '    OTP has been send successfully!    ')
                                                user_otp.focus_set()
                                                Button(register_frame,
                                                       text="                   Register                      ",
                                                       fg='white',
                                                       bg='black', bd=0, font=('Blogger_Sans', 14, 'bold'),
                                                       cursor='hand2', command=lambda: [
                                                        otp_function(str(user_name.get()), str(user_age.get()),
                                                                     str(user_contact.get()), str(user_email.get()),
                                                                     str(user_address.get()),
                                                                     str(user_pincode.get()),
                                                                     str(user_identity.get()),
                                                                     str(user_password.get()),
                                                                     str(user_otp.get()), 'confirm')]).place(x=95,
                                                                                                             y=635)
                                            else:
                                                if otp_got_from_user == 'Type your otp' or otp_got_from_user == '':
                                                    tmsg.showerror('Error', '   Please enter your otp !   ')
                                                    user_otp.focus_set()
                                                elif user_otp.get().isdigit():  # I have not written len(user_otp.get()) == 6: because sometimes user get a 5 digit otp number because for some bugs
                                                    otp_verification(otp, user_otp.get(), r'users.csv',
                                                                     [str(user_name.get()),
                                                                      str(user_age.get()),
                                                                      str(user_contact.get()),
                                                                      str(user_email.get()),
                                                                      str(user_address.get()),
                                                                      str(user_pincode.get()),
                                                                      str(user_identity.get()),
                                                                      str(user_contact.get()) + str(
                                                                          user_email.get()) + str(
                                                                          user_identity.get()) + str(
                                                                            current_date) + str(current_time),
                                                                      str(user_wallet_balance),
                                                                      str(user_password.get()),
                                            ...
                                            tmsg.showerror('Error',
                                                           '   Please enter valid aadhar card number (i.e. 12 digit aadhar number)   ')
                                            user_identity.focus_set()
                                    else:
                            ...
                            tmsg.showerror('Error',
                                           '   Please enter valid phone number (i.e. 10 digit phone number)   ')
                            user_contact.focus_set()
                    else:
    ...
    Button(register_frame, text="                   Get OTP                   ", bd=0, bg="black", fg="white",
           font=('Blogger_Sans', 14),
           cursor='hand2', command=lambda: [otp_function(str(user_name.get()), str(user_age.get()),
                                                         str(user_contact.get()), str(user_email.get()),
                                                         str(user_address.get()), str(user_pincode.get()),
                                                         str(user_identity.get()), str(user_password.get()),
                                                         str(user_otp.get()), 'get_otp')]).place(x=95, y=635)
...
def buy(product_index):
    if os.path.exists(r'login.csv'):
        ...
        img = image(r"images/return_icon.png", 40, 40)
        return_icon = Button(frame5, image=img, bd=0, cursor="hand2",
                             command=return_back)
        return_icon.place(x=10, y=10)
        return_icon.image = img
        ...
        for i in products_df.index:
            ...
            if int(product_index) == i:
                if int(products_list[3]) != 0:
                    ...
                    Label(product_frame, textvariable=product_cost, bg='white',
                          font=('Amaranth-Bold', 10, 'bold')).place(anchor=W,
                                                                    x=155,
                                                                    y=70)
                    ...
                    if int(product_stock.get()) < 100:
                        Label(product_frame, text=f'Hurry! Only {product_stock.get()} pcs are left', bg='white',
                              fg='red',
                              font=('Amaranth-Regular', 10)).place(
                            anchor=W,
                            x=155,
                            y=140)
                    ...
                    def less_qty_function(quantity):
                        if quantity.isdigit():
                            if int(quantity) < int(products_list[3]) or int(quantity) == int(products_list[3]):
                                ...
                                tmsg.showwarning('Error',
                                                 f"Quantity must be lower than product's stock i.e. {products_list[3]} pcs")
                        else:
                    ...
                    Label(buy_frame, text="Quantity", font=("ABeeZee-Regular", 10, 'bold'), fg='black', bg='white'
                          ).place(x=50, y=190)

                    Button(buy_frame, text='-  ', bg='white', font=('Amaranth-Bold', 14, 'bold'), bd=0,
                           fg='black', command=lambda: [less_qty_function(str(user_quantity.get())),
                                                        continue_buy(str(user_quantity.get()), pro_stock, pro_cost,
                                                                     'no')], cursor='hand2',
                           ).place(x=155, y=180)
                    ...
                    user_quantity.bind('<Configure>', lambda e: [continue_buy(str(user_quantity.get()),
                                                                              pro_stock, pro_cost, 'yes')])
                    Frame(buy_frame, width=20, height=3, bg='black', bd=0).place(x=175, y=205)
                    Button(buy_frame, text=' + ', bg='white', font=('Amaranth-Bold', 12, 'bold'), bd=0,
                           fg='black', command=lambda: [add_qty_function(str(user_quantity.get())),
                                                        continue_buy(str(user_quantity.get()), pro_stock, pro_cost,
                                                                     'no')], cursor='hand2',
                           ).place(x=195, y=184)

                    # RADIO BUTTONS FOR PAY VIA SAS ACCOUNT AND CASH ON DELIVERY

                    payment_type = StringVar()
                    payment_type.set("Cash On Delivery")
                    r1 = Radiobutton(buy_frame, text="Pay via SAS ACCOUNT", value="SAS WALLET", variable=payment_type,
                                     bd=0, bg='white', fg='black', cursor='hand2')
                    r1.place(x=50, y=224)
                    r2 = Radiobutton(buy_frame, text="Cash On Delivery", value="Cash On Delivery",
                                     variable=payment_type, bd=0, bg='white', fg='black', cursor='hand2')
                    r2.place(x=230, y=224)

                    def continue_buy(user_qty, stock, product_price, repeat):
                        if user_qty.isdigit():
                            if int(user_qty) < 1 or int(user_qty) > stock:
                                tmsg.showwarning("Incorrect value",
                                                 f"Please enter less than or \nequal to {stock} or more than 0.")
                                if repeat == 'yes':
                                    buy_frame.after(2000, lambda: [continue_buy(str(user_quantity.get()), pro_stock,
                                                                                pro_cost, 'yes')])
                                else:
                                    pass
                            else:
                                user_total_price = int(int(user_qty) * product_price)
                                Label(buy_frame, font=("ABeeZee-Regular", 10, 'bold'), fg='black', bg='white',
                                      text=f"Total Amount Payable   :       ₹ {user_total_price}\t\t\t"
                                      ).place(x=50, y=264)
                                    ...
                                    for user_id in user_df.index:
                                        if int(user_id_list[0]) == user_id:
                                            ...
                                            if int(user_list[8]) > user_total_price or int(
                                                ...
                                                order_code = str(
                                                    user_email + user_contact + purchase_date + purchase_time)
                                                Label(buy_frame, font=("ABeeZee-Regular", 10, 'bold'), fg='black',
                                                      bg='white',
                                                      text=f"SAS Wallet Balance   :          ₹ {int(user_list[8])}\t\t\t"
                                                      ).place(x=50, y=294)
                                            else:
                                                user_name = str(user_list[0])
                                                user_age = str(user_list[1])
                                                ...
                                                order_code = str(
                                                    user_email + user_contact + purchase_date + purchase_time)
                                                Label(buy_frame, font=("ABeeZee-Regular", 10, 'bold'), fg='red',
                                                      bg='white',
                                                      text=f"Your balance is low   :          ₹ {int(user_list[8])}\t\t\t",
                                                      ).place(x=50, y=294)
                                                payment_type.set('Cash On Delivery')
                                                r1.destroy()
                            ...
                            def continue_command():
                                time.sleep(2)
                                confirm_payment(int(product_id.get()), payment_type.get(), user_qty, user_total_price,
                                                user_name, user_age, user_contact, user_email, user_address,
                                                user_pincode, purchase_date, purchase_time, order_code)

                            Button(buy_frame, text="    Continue To Buy    ", fg='white', bg='black',
                                   font=("comicsansms", 10),
                                   command=continue_command, bd=0,
                                   cursor='hand2').place(x=140, y=340)
                        ...
                        def confirm_payment(pro_index, payment, confirm_user_qty, confirm_user_total_price,
                                            confirm_user_name, confirm_user_age, confirm_user_contact,
                                            confirm_user_email, confirm_user_address, confirm_user_pincode,
                                            confirm_purchase_date, confirm_purchase_time, confirm_order_code):
                            user_information = [str(pro_index), str(confirm_user_qty), str(confirm_user_total_price),
                                                str(confirm_user_name), str(confirm_user_age),
                                                str(confirm_user_contact), str(confirm_user_email),
                                                str(confirm_user_address), str(confirm_user_pincode),
                                                str(confirm_purchase_date),
                                                str(confirm_purchase_time), str(confirm_order_code), str(payment)]
                            ...
                            for order_id in updated_orders_df.index:
                                ...
                                if str(confirm_order_code) == x[11]:
                                    ...
                                    send_mail("Your Order Confirmation Email from SAS", customer_email,
                                              f"Your order has been confirmed. Order for {pro_name} ({pro_details}) of {customer_quantity} piece/pieces of ₹ {customer_total_price} has been successfully placed. You will receive your order soon.\n\nOrder ID : {order_id}\nName : Mr./Mrs. {customer_name}\nContact no : +91 {customer_contact}\nEmail id : {customer_email}\nDelivery Address : {customer_address}\nPincode : {customer_pincode}\nDate of buying the product : {email_purchase_date}\nTime of buying the product : {email_purchase_time}\nPayment Mode : {payment_mode}.\n\nThank You for choosing us"
                                              )
                                    
                            # CHANGE IN STOCK WITH RESPECT TO QUANTITY
...
def login(previous_frame):
    ...
    img = image(r"images/return_icon.png", 40, 40)
    return_icon = Button(frame6, image=img, bd=0, cursor="hand2",
                         command=return_back)
    return_icon.place(x=10, y=10)
    return_icon.image = img

    login_label = Label(login_frame, text="L O G I  N", bd=0, bg='white', fg='black',
                        font=('Helvetica bold', 20))
    ...
    login_button = Button(login_frame, image=login_img, bd=0, cursor='hand2',
    ...
    # register button
    Label(login_frame, text='or Register using', bg='white', fg='black', bd=0, font=('ABeeZee-Regular', 10, 'bold')
          ).place(x=175, y=520)
    register_img = image(r'images/sign_up_icon.jpg', 250, 35)
    register_button = Button(login_frame, image=register_img, bd=0, cursor='hand2',
                             command=lambda: [register(), frame6.forget(),
                                              restore(frame4)])
...
def account(previous_frame):
    ...
    def change_user_password():
        ...
        return_back_of_change_password_return_icon = Button(frame10, image=return_back_of_change_password_img, bd=0,
                                                            cursor="hand2",
                                                            command=return_back_of_change_password)
        ...
        change_password_label = Label(change_password_frame, text="CHANGE PASSWORD", bd=0, bg='white', fg='black',
                                      font=('Helvetica bold', 20))
        ...
        Button(change_password_frame, bg='black', fg='white', bd=0, font=('Blogger_Sans-Bold', 12, 'bold'),
               text='    CHANGE PASSWORD    ', cursor='hand2', command=change_user_password_command).place(x=108, y=464)

        Label(change_password_frame).pack(pady=500)

    img = image(r"images/return_icon.png", 40, 40)
    return_icon = Button(frame8, image=img, bd=0, cursor="hand2",
                         command=return_back)
    return_icon.place(x=10, y=10)
    return_icon.image = img
    ...
    account_label = Label(account_frame, text="ACCOUNT DETAILS", bd=0, bg='white', fg='black',
                          font=('Helvetica bold', 20))
    ...
    for i in df.index:
        ...
        Label(account_frame, bg='white', fg='black', bd=0, font=('Blogger_Sans', 10, 'italic'),
              text=f'User ID : {y[0]}').place(x=50, y=140)
        Label(account_frame, bg='white', fg='black', bd=0, font=('Blogger_Sans', 10, 'italic'),
              text=f'Name : {x[0]}').place(x=50, y=170)
        Label(account_frame, bg='white', fg='black', bd=0, font=('Blogger_Sans', 10, 'italic'),
              text=f'Phone number : {x[2]}').place(x=50, y=200)
        Label(account_frame, bg='white', fg='black', bd=0, font=('Blogger_Sans', 10, 'italic'),
              text=f'Email ID : {x[3]}').place(x=50, y=230)
        Label(account_frame, bg='white', fg='black', bd=0, font=('Blogger_Sans', 10, 'italic'),
              text=f'Address : {x[4]}').place(x=50, y=260)
        Label(account_frame, bg='white', fg='black', bd=0, font=('Blogger_Sans', 10, 'italic'),
              text=f'Pincode : {x[5]}').place(x=50, y=290)
        if int(x[8]) == 0:
            Label(account_frame, bg='white', fg='red', bd=0, font=('Blogger_Sans', 10, 'italic'),
                  text=f'SAS Wallet Balance :   ₹ {x[8]}').place(x=50, y=320)
        else:
            Label(account_frame, bg='white', fg='black', bd=0, font=('Blogger_Sans', 10, 'italic'),
                  text=f'SAS Wallet Balance :   ₹ {x[8]}').place(x=50, y=320)
        ...
        Button(account_frame, bg='black', fg='white', bd=0, font=('Blogger_Sans-Bold', 12, 'bold'),
               text='    LOGOUT    ', cursor='hand2', command=lambda: [os.remove(r'login.csv'),
                                                                       tmsg.showinfo('Successfully',
                                                                                     '    Your account have been successfully logged out    '),
                                                                       return_back()]).place(x=300, y=360)

        # CHANGE PASSWORD

        Button(account_frame, bg='black', fg='white', bd=0, font=('Blogger_Sans-Bold', 12, 'bold'),
               text='    CHANGE PASSWORD    ', cursor='hand2', command=lambda: [frame8.forget(), restore(frame10),
                                                                                change_user_password()]).place(x=50,
                                                                                                               y=360)
...
def admin_login():
    ...
    img = image(r"images/return_icon.png", 40, 40)
    return_icon = Button(admin_login_frame, image=img, bd=0, cursor="hand2",
                         command=return_back)
    return_icon.place(x=10, y=10)
    return_icon.image = img

    admin_login_label = Label(admin_temp_login_frame, text="L O G I  N", bd=0, bg='white', fg='black',
                              font=('Helvetica bold', 20))
    ...
    login_img = image(r'images/login_icon.png', 250, 40)
    login_button = Button(admin_temp_login_frame, image=login_img, bd=0, cursor='hand2',
                          command=login_function)
    login_button.image = login_img
    login_button.place(x=99, y=464)
...
def admin():
    ...
    img = image(r"images/return_icon.png", 40, 40)
    return_icon = Button(admin_frame, image=img, bd=0, cursor="hand2",
                         command=return_back_confirm)
    return_icon.place(x=10, y=10)
    return_icon.image = img

    Label(admin_frame, text="A D M I N", bg="white", fg="black", font=("BonvenoCF-Light", 36)
          ).place(x=578, y=70)
    ...
    admin_products_button = Button(admin_frame, bg='white', bd=0, image=products_button_image, cursor='hand2',
                                   command=lambda: [admin_frame.forget(),
                                                    admin_products_frame.pack(side='left', anchor='nw', fill=BOTH,
                                                                              expand=True),
                                                    admin_show_products()])
    ...
    users_button = Button(admin_frame, bg='white', bd=0, image=users_button_image, cursor='hand2',
                          command=lambda: [admin_frame.forget(),
                                           admin_users_frame.pack(side=LEFT, anchor=NW, fill=BOTH,
                                                                  expand=True), admin_show_users()])
    ...
    orders_button = Button(admin_frame, bg='white', bd=0, image=orders_button_image, cursor='hand2',
                           command=lambda: [admin_frame.forget(),
                                            admin_orders_frame.pack(side=LEFT, anchor=NW, fill=BOTH,
                                                                    expand=True), admin_show_orders()])
    ...
    admin_feedback_button = Button(admin_frame, bg='white', bd=0, image=feedback_button_image, cursor='hand2',
                                   command=lambda: [admin_frame.forget(),
                                                    admin_feedback_frame.pack(side='left', anchor='nw', fill=BOTH,
                                                                              expand=True), admin_show_feedback()])
    ...
    def sales_chart():
        ...
        plt.title(
            f"Sales Chart Of SAS Store from {list(sales_df[0])[0]} to {list(sales_df[0])[int(len(sales_df[0]) - 1)]}")
        plt.show()
    ...
    sales_chart_button = Button(admin_frame, bg='white', bd=0, image=sales_chart_button_image, cursor='hand2',
                                command=sales_chart)
    ...
    change_password_button = Button(admin_frame, bg='white', bd=0, image=change_password_button_image, cursor='hand2',
                                    command=lambda: [admin_frame.forget(),
                                                     admin_change_password_frame.pack(side=LEFT, anchor=NW),
...
def admin_show_products():
    ...
    img = image(r"images/return_icon.png", 40, 40)
    return_icon = Button(admin_show_products_frame_1, image=img, bd=0, cursor="hand2",
                         command=return_back)
    return_icon.place(x=10, y=10)
    return_icon.image = img
    ...
    search_btn = Button(admin_show_products_frame_1, image=search_img, bd=0, cursor="hand2",
                        command=lambda: [temp_frame.forget(), admin_products_frame.pack(anchor=NW),
                                         admin_product_search()])
    ...
    def admin_product_search():
        ...
        return_button = Button(scrollabel_frame, image=img_, bd=0, cursor="hand2",
                               command=lambda: [temp_frame_.destroy(), return_back()])
        return_button.place(x=15, y=10)
        ...
        for _ in df_.index:
            ...
            if search_admin.get().lower() == x_[0].lower():
                ...
                Label(products_bg_frame_, textvariable=product_cost_, bg='white',
                      font=('ABeeZee-Regular', 10, 'bold')).place(
                    anchor=W,
                    x=700,
                    y=30)
                Label(products_bg_frame_, textvariable=product_stock_, bg='white',
                      font=('ABeeZee-Regular', 10, 'bold')).place(
                    anchor=W,
                    x=500,
                    y=110)
                Label(products_bg_frame_, textvariable=product_name_, bg='white', fg='black',
                      font=('ABeeZee-Regular', 10, 'bold')).place(
                    anchor=W,
                    x=500,
                    y=30)
                Label(products_bg_frame_, textvariable=product_details_, bg='white', fg='#777777',
                      font=('Amaranth-Regular', 8)).place(
                    anchor=W,
                    x=500,
                    y=70)

                delete_button[i] = Button(products_bg_frame_, image=delete_image,
                                          cursor="hand2", bd=0, command=lambda: [temp_frame_.destroy(),
                                                                                 delete_action()])
                delete_button[i].place(anchor=NW, x=525, y=140)
                delete_button[i].image = delete_image

                add_products_stock[i] = Button(products_bg_frame_, image=add_stock_image,
                                               cursor="hand2", bd=0, command=lambda: [temp_frame_.destroy(),
                                                                                      add_products_stock_action_search()])
    ...
    Label(admin_show_products_frame_1, text='Products', bg='white', bd=0, font=("Blooger_Sans-Bold", 24, "bold")
          ).place(x=20, y=120)
    ...
    def add_product_action():
        ...
        img_ = image(r"images/return_icon.png", 40, 40)
        return_icon_ = Button(temp_frame__, image=img_, bd=0, cursor="hand2",
                              command=admin_product_return_back)
        return_icon_.place(x=10, y=10)
        return_icon_.image = img_

        add_product_frame.pack(padx=450, pady=40)

        add_product_label = Label(add_product_frame, text="Add Product", bd=0, bg='white', fg='black',
                                  font=('Helvetica bold', 20))
        ...
        def add_product_command():
            csv_write(r'products.csv', 'a+', [str(product_name_.get()), str(product_price.get()),
                                              str(product_details_.get()), str(product_stock_.get()),
                                              str(product_image_.get())])
            tmsg.showinfo("Successful", "    Product has been added successfully !   ")
            admin_product_return_back()

        add_products_button_ = Button(add_product_frame, image=add_products_image, bg="white", bd=0,
                                      cursor="hand2", command=add_product_command)
    ...
    add_products_button = Button(admin_show_products_frame_1, image=add_products_image, bg="white", bd=0,
                                 cursor="hand2", command=add_product_action)
    ...
    for i in df.index:
        ...
        def add_products_stock_action(add_product_stock_id):
            ...
            add_stock_frame = Frame(add_products_stock_frame, highlightthickness=5, highlightbackground='black',
                                    bg='white')
            ...
            add_stock_return_back = Button(add_products_stock_frame, image=img, bd=0, cursor="hand2",
                                           command=add_stock_return_back)
            add_stock_return_back.place(x=10, y=10)
            add_stock_return_back.image = img

            add_stock_label = Label(add_stock_frame, text="ADD STOCK", bd=0, bg='white', fg='black',
                                    font=('Helvetica bold', 20))
            ...
            for c in df.index:
                if add_product_stock_id == c:
                    ...
                    Label(add_stock_frame, text=f'Name : {z[0]}', bg='white', fg='black',
                          font=('Amaranth-Regular', 8)).place(
                        anchor=W,
                        x=155,
                        y=200)
                    Label(add_stock_frame, text=f'Price : {z[1]}', bg='white', font=('Amaranth-Regular', 8)).place(
                        anchor=W,
                        x=155,
                        y=220)
                    Label(add_stock_frame, text=f'Details : {z[2]}', bg='white', fg='#777777',
                          font=('Amaranth-Regular', 8)).place(
                        anchor=W,
                        x=155,
                        y=240)
                    Label(add_stock_frame, text=f'Current Stock : {z[3]} pc(s)', bg='white',
                          font=('Amaranth-Regular', 8)).place(x=220, y=210)

            # stock
            stock_icon = Label(add_stock_frame, bd=0, bg="white", text="₹")
            ...
            login_img = image(r'images/login_icon.png', 250, 40)
            login_button = Button(add_stock_frame, image=login_img, bd=0, cursor='hand2',
                                  command=add_stock_function)
            login_button.image = login_img
            login_button.place(x=99, y=504)
        ...
        product_image.image = product_img
        Label(products_bg_frame, textvariable=product_cost, bg='white', font=('ABeeZee-Regular', 10, 'bold')).place(
            anchor=W,
            x=700,
            y=30)
        Label(products_bg_frame, textvariable=product_stock, bg='white', font=('ABeeZee-Regular', 10, 'bold')).place(
            anchor=W,
            x=500,
            y=110)
        Label(products_bg_frame, textvariable=product_name, bg='white', fg='black',
              font=('ABeeZee-Regular', 10, 'bold')).place(
            anchor=W,
            x=500,
            y=30)
        Label(products_bg_frame, textvariable=product_details, bg='white', fg='#777777',
              font=('Amaranth-Regular', 8)).place(
            anchor=W,
            x=500,
            y=70)

        delete_button[i] = Button(products_bg_frame, image=delete_image,
                                  cursor="hand2", bd=0, command=delete_action)
        delete_button[i].place(anchor=NW, x=525, y=140)
        delete_button[i].image = delete_image

        add_products_stock[i] = Button(products_bg_frame, image=add_stock_image,
                                       cursor="hand2", bd=0, command=add_products_stock_action_manual)
        add_products_stock[i].place(anchor=NW, x=699, y=140)
        add_products_stock[i].image = add_stock_image
...
def admin_show_users():
    ...
    img = image(r"images/return_icon.png", 40, 40)
    return_icon = Button(admin_show_users_frame_1, image=img, bd=0, cursor="hand2",
                         command=return_back)
    return_icon.place(x=10, y=10)
    return_icon.image = img
    ...
    search_admin.bind("<Return>", enter)
    search_btn = Button(admin_show_users_frame_1, image=search_img, bd=0, cursor="hand2",
                        command=lambda: [temp_frame.forget(), admin_users_frame.pack(anchor=NW),
                                         admin_user_search()])
    search_btn.place(x=800, y=57)
    search_btn.image = search_img
    ...
    def admin_user_search():
        ...
        for _ in df_.index:
            ...
            if search_admin.get().lower() == x_[0].lower():
                ...
                Label(users_bg_frame_, textvariable=user_age_, bg='white',
                      font=('ABeeZee-Regular', 10, 'bold')).place(
                    anchor=W,
                    x=700,
                    y=30)
                Label(users_bg_frame_, textvariable=user_email_, bg='white',
                      font=('ABeeZee-Regular', 10, 'bold')).place(
                    anchor=W,
                    x=500,
                    y=70)
                Label(users_bg_frame_, textvariable=user_name_, bg='white', fg='black',
                      font=('ABeeZee-Regular', 10, 'bold')).place(
                    anchor=W,
                    x=500,
                    y=30)
                Label(users_bg_frame_, textvariable=user_address_, bg='white', fg='#777777',
                      font=('Amaranth-Regular', 8)).place(
                    anchor=W,
                    x=500,
                    y=110)

                add_users_balance[_] = Button(users_bg_frame_, text="Add Balance", bg="black", fg="white",
                                              font=("Blogger_Sans", 8, "bold"), cursor="hand2", bd=0,
                                              command=add_users_balance_action_search)
    ...
    Label(admin_show_users_frame_1, text='Users', bg='white', bd=0, font=("Blooger_Sans-Bold", 24, "bold")
          ).place(x=20, y=120)
    ...
    for i in df.index:
        ...
        def add_users_balance_action(add_user_balance_id):
            ...
            add_balance_frame = Frame(add_users_balance_frame, highlightthickness=5, highlightbackground='black',
                                      bg='white')
            ...
            add_balance_return_back = Button(add_users_balance_frame, image=img, bd=0, cursor="hand2",
                                             command=add_balance_return_back)
            add_balance_return_back.place(x=10, y=10)
            add_balance_return_back.image = img

            add_balance_label = Label(add_balance_frame, text="ADD balance", bd=0, bg='white', fg='black',
                                      font=('Helvetica bold', 20))
            ...
            for c in df.index:
                if add_user_balance_id == c:
                    ...
                    Label(add_balance_frame, text=f'Name : {z[0]}', bg='white', fg='black',
                          font=('Amaranth-Regular', 8)).place(
                        anchor=W,
                        x=155,
                        y=200)
                    Label(add_balance_frame, text=f'Age : {z[1]}', bg='white', font=('Amaranth-Regular', 8)).place(
                        anchor=W,
                        x=155,
                        y=220)
                    Label(add_balance_frame, text=f'Address : {z[4]}', bg='white', fg='#777777',
                          font=('Amaranth-Regular', 8)).place(
                        anchor=W,
                        x=155,
                        y=240)
                    Label(add_balance_frame, text=f'Email : {z[3]}', bg='white',
                          font=('Amaranth-Regular', 8)).place(x=220, y=210)
            ...
            login_img = image(r'images/login_icon.png', 250, 40)
            login_button = Button(add_balance_frame, image=login_img, bd=0, cursor='hand2',
                                  command=add_balance_function)
            login_button.image = login_img
            login_button.place(x=99, y=504)
        ...
        Label(users_bg_frame, textvariable=user_age, bg='white', font=('ABeeZee-Regular', 10, 'bold')).place(
            anchor=W,
            x=700,
            y=30)
        Label(users_bg_frame, textvariable=user_email, bg='white', font=('ABeeZee-Regular', 10, 'bold')).place(
            anchor=W,
            x=500,
            y=70)
        Label(users_bg_frame, textvariable=user_name, bg='white', fg='black',
              font=('ABeeZee-Regular', 10, 'bold')).place(
            anchor=W,
            x=500,
            y=30)
        Label(users_bg_frame, textvariable=user_address, bg='white', fg='#777777',
              font=('Amaranth-Regular', 8)).place(
            anchor=W,
            x=500,
            y=110)

        add_users_balance[i] = Button(users_bg_frame, text="Add Balance", bg="black", fg="white",
                                      font=("Blogger_Sans", 8, "bold"), cursor="hand2", bd=0,
                                      command=add_users_balance_action_manual)
...
def admin_show_orders():
    ...
    img = image(r"images/return_icon.png", 40, 40)
    return_icon = Button(admin_show_orders_frame_1, image=img, bd=0, cursor="hand2",
                         command=return_back)
    return_icon.place(x=10, y=10)
    return_icon.image = img
    ...
    search_admin.bind("<Return>", enter)
    search_btn = Button(admin_show_orders_frame_1, image=search_img, bd=0, cursor="hand2",
                        command=lambda: [temp_frame.forget(), admin_orders_frame.pack(anchor=NW),
                                         admin_orders_search()])
    search_btn.place(x=800, y=57)
    search_btn.image = search_img
    ...
    def admin_orders_search():
        ...
        for _ in df_.index:
            ...
            if search_admin.get().lower() == x_[3].lower():
                ...
                orders_qty_total_amt_id_payment_mode_.set(
                    f'Qty : {x_[1]} pc(s)    Amt : ₹ {x_[2]}    Order ID : {_}    '
                    f'Payment Mode : {x_[12]}')
                ...
                Label(orders_bg_frame_, textvariable=orders_product_id_, bg='white',
                      font=('ABeeZee-Regular', 10, 'bold')).place(
                    anchor=W,
                    x=700,
                    y=30)
                Label(orders_bg_frame_, textvariable=orders_email_, bg='white',
                      font=('ABeeZee-Regular', 10, 'bold')).place(
                    anchor=W,
                    x=500,
                    y=70)
                Label(orders_bg_frame_, textvariable=orders_name_, bg='white', fg='black',
                      font=('ABeeZee-Regular', 10, 'bold')).place(
                    anchor=W,
                    x=500,
                    y=30)
                Label(orders_bg_frame_, textvariable=orders_address_, bg='white', fg='#777777',
                      font=('Amaranth-Regular', 8)).place(
                    anchor=W,
                    x=500,
                    y=110)
                Label(orders_bg_frame_, textvariable=orders_qty_total_amt_id_payment_mode_, bg='white', fg='#777777',
                      font=('Amaranth-Regular', 8)).place(
                    anchor=W,
                    x=500,
                    y=150)
                Label(orders_bg_frame_, textvariable=orders_purchase_date_time_, bg='white', fg='#777777',
                      font=('Amaranth-Regular', 8)).place(
                    anchor=W,
                    x=500,
                    y=180)
    ...
    Label(admin_show_orders_frame_1, text='orders', bg='white', bd=0, font=("Blooger_Sans-Bold", 24, "bold")
          ).place(x=20, y=120)
    ...
    for i in df.index:
        ...
        orders_qty_total_amt_id_payment_mode.set(f'Qty : {x[1]} pc(s)    Amt : ₹ {x[2]}    Order ID : {i}    '
                                                 f'Payment Mode : {x[12]}')
        ...
        Label(orders_bg_frame, textvariable=orders_product_id, bg='white', font=('ABeeZee-Regular', 10, 'bold')).place(
            anchor=W,
            x=700,
            y=30)
        Label(orders_bg_frame, textvariable=orders_email, bg='white', font=('ABeeZee-Regular', 10, 'bold')).place(
            anchor=W,
            x=500,
            y=70)
        Label(orders_bg_frame, textvariable=orders_name, bg='white', fg='black',
              font=('ABeeZee-Regular', 10, 'bold')).place(
            anchor=W,
            x=500,
            y=30)
        Label(orders_bg_frame, textvariable=orders_address, bg='white', fg='#777777',
              font=('Amaranth-Regular', 8)).place(
            anchor=W,
            x=500,
            y=110)
        Label(orders_bg_frame, textvariable=orders_qty_total_amt_id_payment_mode, bg='white', fg='#777777',
              font=('Amaranth-Regular', 8)).place(
            anchor=W,
            x=500,
            y=150)
        Label(orders_bg_frame, textvariable=orders_purchase_date_time, bg='white', fg='#777777',
              font=('Amaranth-Regular', 8)).place(
            anchor=W,
            x=500,
            y=180)
...
def admin_show_feedback():
    ...
    img = image(r"images/return_icon.png", 40, 40)
    return_icon = Button(admin_show_feedback_frame_1, image=img, bd=0, cursor="hand2",
                         command=return_back)
    return_icon.place(x=10, y=10)
    return_icon.image = img
    ...
    search_admin.bind("<Return>", enter)
    search_btn = Button(admin_show_feedback_frame_1, image=search_img, bd=0, cursor="hand2",
                        command=lambda: [temp_frame.forget(), admin_feedback_frame.pack(anchor=NW),
                                         admin_feedback_search()])
    search_btn.place(x=800, y=57)
    search_btn.image = search_img
    ...
    def admin_feedback_search():
        ...
        for i in df_.index:
            ...
            if search_admin.get().lower() == x_[0].lower():
                ...
                Label(feedback_bg_frame_, textvariable=feedback_type_, bg='white',
                      font=('ABeeZee-Regular', 10, 'bold')).place(
                    anchor=W,
                    x=700,
                    y=30)
                Label(feedback_bg_frame_, textvariable=feedback_email_, bg='white',
                      font=('ABeeZee-Regular', 10, 'bold')).place(
                    anchor=W,
                    x=500,
                    y=70)
                Label(feedback_bg_frame_, textvariable=feedback_name_, bg='white', fg='black',
                      font=('ABeeZee-Regular', 10, 'bold')).place(
                    anchor=W,
                    x=500,
                    y=30)
                Label(feedback_bg_frame_, textvariable=feedback_report_, bg='white', fg='#777777',
                      font=('Amaranth-Regular', 8)).place(
                    anchor=W,
                    x=500,
                    y=110)
    ...
    Label(admin_show_feedback_frame_1, text='Feedback', bg='white', bd=0, font=("Blooger_Sans-Bold", 24, "bold")
          ).place(x=20, y=120)
    ...
    for i in df.index:
        ...
        Label(feedback_bg_frame, textvariable=feedback_type, bg='white', font=('ABeeZee-Regular', 10, 'bold')).place(
            anchor=W,
            x=700,
            y=30)
        Label(feedback_bg_frame, textvariable=feedback_email, bg='white', font=('ABeeZee-Regular', 10, 'bold')).place(
            anchor=W,
            x=500,
            y=70)
        Label(feedback_bg_frame, textvariable=feedback_name, bg='white', fg='black',
              font=('ABeeZee-Regular', 10, 'bold')).place(
            anchor=W,
            x=500,
            y=30)
        Label(feedback_bg_frame, textvariable=feedback_report, bg='white', fg='#777777',
              font=('Amaranth-Regular', 8)).place(
            anchor=W,
            x=500,
            y=110)
...
def admin_change_password():
    ...
    change_password_frame = Frame(admin_change_password_frame, highlightthickness=5, highlightbackground='black',
                                  bg='white')
    change_password_frame.pack(padx=450, pady=40)
    ...
    return_back_of_change_password_img = image(r"images/return_icon.png", 40, 40)
    return_back_of_change_password_return_icon = Button(admin_change_password_frame,
                                                        image=return_back_of_change_password_img, bd=0,
                                                        cursor="hand2",
                                                        command=return_back_of_change_password)
    return_back_of_change_password_return_icon.place(x=10, y=10)
    return_back_of_change_password_return_icon.image = return_back_of_change_password_img
    ...
    Button(change_password_frame, bg='black', fg='white', bd=0, font=('Blogger_Sans-Bold', 12, 'bold'),
           text='    CHANGE PASSWORD    ', cursor='hand2', command=change_admin_password_command).place(x=108, y=464)
...
sign_in_as_admin_button = Button(frame1, image=sign_in_as_admin_image, bg='white', cursor='hand2', bd=0,
                                 command=lambda: [frame1.forget(), frame2.forget(), admin_login(),
                                                  admin_login_frame.pack(anchor=W)])
